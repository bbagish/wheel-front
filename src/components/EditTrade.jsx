...
import { saveTrade, closeTrade } from '../services/tradeService';
...
const EditTrade = ({ trade }) => {
    ...
    const [filledDate, setFilledDate] = useState(trade.filledDate);
    const [expirationDate, setExpirationDate] = useState(trade.expirationDate);
    const [strikePrice, setStrikePrice] = useState(trade.strikePrice);
    const [premium, setPremium] = useState(trade.premium);
    const [type, setType] = useState(trade.type);
    const [closingPrice, setClosingPrice] = useState(trade.closingPrice);
    ...
    //TODO: once trade is updated id changes
